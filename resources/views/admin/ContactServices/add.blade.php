...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/ContactServices/insert')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>upload  contact banner </div>
          ...
          <div class="card-body">
            ...
            {{-- // heading end  --}}
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> service ingo   <span class="req_star">*</span>:</label>
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="service_info" >
              </div>
            </div>
            {{-- // caption end  --}}
            ...
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="service_button" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="google_map" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="support_title" >
              </div>
            </div>
            {{-- end  --}}
            ...
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="support_mail" >
              </div>
            </div>
            {{-- end  --}}
            ...
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="support_phone" >
              </div>
            </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="review_title" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="review_subtitle" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="review_info" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
