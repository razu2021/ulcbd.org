...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/HomePageTestimonial/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>testimonial   </div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/HomePageTestimonial')}}"><i class="fa fa-th"></i>all information </a>
              </div>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> review   <span class="req_star">*</span>:</label>
              <div class="col-md-7">
