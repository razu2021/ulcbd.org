    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header bg-secondary">
              <div class="row">
                <div class="col-md-8 card_header_title text-white"><i class="fa fa-gg-circle"></i>Our Clients Quesions</div>
                <div class="col-md-4 text-end card_header_btn">
                  <a class="btn btn-sm btn-dark" href="#"><i class="fa fa-plus-circle"></i>wellcome </a>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              @foreach ($all as $data)
                  <tr>
                    ...
                    <td>{{Str::words($data->client_quesion,5)}}</td> 
                    <td>
                      <div class="btn-group" role="group">
                        <div class="btn-group" role="group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('dashboard/website/OurClientsQuesion/view/'.$data->slug)}}">View</a></li>
                            <li><a class="dropdown-item" href="{{url('dashboard/website/OurClientsQuesion/edit/'.$data->slug)}}">Answer This Quesion</a></li>
                            <li><a class="dropdown-item" href="#" id="softdelete" data-bs-toggle="modal" data-bs-target="#softdelete-modal" data-id="{{$data->clientsq_id}}">Delete</a></li>
...
<div id="softdelete-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <form method="post" action="{{url('dashboard/website/OurClientsQuesion/softdelete')}}">
        @csrf
