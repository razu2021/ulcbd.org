...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/OurClientsQuesion/update')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>our client quesion  </div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/OurClientsQuesion')}}"><i class="fa fa-th"></i>All  quesion   </a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="row mb-2">
              ...
              <div class="col-md-7">
                <input type="hidden" name="id"  value="{{$data->clientsq_id}}">
            ...
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> Clients Quesion    <span class="req_star">*</span>:</label>
              <div class="col-md-7">
                <input type="text" class="form-control form_control" disabled id="" name="clientsq_id" value="{{$data->client_quesion}}">
              </div>
            </div>
            ...
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> Clients Quesion    <span class="req_star">*</span>:</label>
              <div class="col-md-7">
                <textarea type="text" rows="8" cols="50" class="form-control form_control"  id="" name="ansqwer" ></textarea>
              </div>
            </div>
