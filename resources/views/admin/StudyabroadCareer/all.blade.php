            ...
            <div class="card-header bg-secondary">
              <div class="row">
                ...
                <div class="col-md-4 text-end card_header_btn">
                  <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/StudyabroadCareer/add')}}"><i class="fa fa-plus-circle"></i>add career </a>
                </div>
              </div>
            </div>
            <div class="card-body">
                      ...
                      <div class="btn-group" role="group">
                        <div class="btn-group" role="group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('dashboard/website/StudyabroadCareer/view/'.$data->slug)}}">View</a></li>
                            <li><a class="dropdown-item" href="{{url('dashboard/website/StudyabroadCareer/edit/'.$data->slug)}}">Edit</a></li>
...
<div id="softdelete-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <form method="post" action="{{url('dashboard/website/StudyabroadCareer/softdelete')}}">
        @csrf
