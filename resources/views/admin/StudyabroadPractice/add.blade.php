...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/StudyabroadPractice/insert')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          ...
          <div class="card-body">
            ...
            {{-- // about end  --}}
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> university name <span class="req_star">*</span>:</label>
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="university_name" >
              </div>
            </div>
            {{-- // about end  --}}
            <div class="row mb-2">
            ...
            {{-- // about end  --}}
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label">iframe_link  <span class="req_star">*</span>:</label>
              <div class="col-md-7">
                <input type="text" class="form-control form_control" id="" name="iframe_link" >
              </div>
            </div>
            {{-- end  --}}
            <div class="row mb-2">
