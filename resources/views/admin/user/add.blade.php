      ...
      <form method="post" action="">
        <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>User Registration</div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/user')}}"><i class="fa fa-th"></i>All User information </a>
              </div>
            </div>
          </div>
          <div class="card-body">
          ...
          <div class="card-footer bg-secondary text-center">
            <button class="btn btn-md btn-dark">REGISTRATION</button>
          </div>
      </div>
      </form>
  </div>
