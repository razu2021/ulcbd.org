...
<div class="row">
  <div class="col-xl-12">
      <form method="post" action="{{url('dashboard/website/news/insert')}}" enctype="multipart/form-data">
        @csrf
        <div class="card">
          ...
          <div class="card-body">
           ...
           {{-- end  --}}
            ...
            {{-- end  --}}
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label">news  Button:</label>
              <div class="col-md-7">
            ...
            {{-- end  --}}
            <div class="row mb-2">
              <label class="col-md-3 col-form-label col_form_label"> news image<span class="req_star">*</span>:</label>
              <div class="col-md-7">
