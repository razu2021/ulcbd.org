  ...
  <div class="col-xl-12">
      <div class="card">
          <div class="card-header bg-secondary">
            <div class="row">
              <div class="col-md-8 card_header_title"><i class="fa fa-gg-circle"></i>View news Information</div>
              <div class="col-md-4 text-end card_header_btn">
                <a class="btn btn-sm btn-dark" href="{{url('dashboard/website/news')}}"><i class="fa fa-th"></i>All news </a>
              </div>
            </div>
          </div>
          <div class="card-body">
              ...
              <div class="col-md-8">
                <table class="table table-bordered table-striped custom_view_table">
                  ...
                  <tr>
                    ...
                    <td>
                      @if($data->news_image!='')
                        <img height="80" src="{{asset('uploads/'.$data->news_image)}}"/>
                      @else
